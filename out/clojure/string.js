...
{{
var G__14014 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14014;
continue;
}
} else
...
{var pred__14018 = cljs.core._EQ_;var expr__14019 = limit;if(cljs.core.truth_(pred__14018.call(null,(1),expr__14019)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14018.call(null,(2),expr__14019)))
...
var G__14021 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14022 = (limit__$1 - (1));
var G__14023 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__14021;
limit__$1 = G__14022;
parts = G__14023;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___14025 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___14025))
{var replacement_14026 = temp__4124__auto___14025;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_14026)));
} else
{buffer.append(ch);
}
{
var G__14027 = (index + (1));
index = G__14027;
continue;
}
}
