...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13609 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13609 = (function (val,box,meta13610){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13609.cljs$lang$type = true;
cljs.core.async.impl.channels.t13609.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13609";
cljs.core.async.impl.channels.t13609.cljs$lang$ctorPrWriter = (function (this__4111__auto__,writer__4112__auto__,opt__4113__auto__){return cljs.core._write.call(null,writer__4112__auto__,"cljs.core.async.impl.channels/t13609");
});
cljs.core.async.impl.channels.t13609.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13609.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13611){var self__ = this;
var _13611__$1 = this;return self__.meta13610;
});
cljs.core.async.impl.channels.t13609.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13611,meta13610__$1){var self__ = this;
var _13611__$1 = this;return (new cljs.core.async.impl.channels.t13609(self__.val,self__.box,meta13610__$1));
});
cljs.core.async.impl.channels.__GT_t13609 = (function __GT_t13609(val__$1,box__$1,meta13610){return (new cljs.core.async.impl.channels.t13609(val__$1,box__$1,meta13610));
});
}
return (new cljs.core.async.impl.channels.t13609(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4114__auto__,writer__4115__auto__,opts__4116__auto__){return cljs.core._write.call(null,writer__4115__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4111__auto__,writer__4112__auto__,opt__4113__auto__){return cljs.core._write.call(null,writer__4112__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13612 = self__.takes.pop();if((taker_13612 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13612))
{var take_cb_13613 = cljs.core.async.impl.protocols.commit.call(null,taker_13612);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13613,taker_13612,this$__$1){
return (function (){return take_cb_13613.call(null,null);
});})(take_cb_13613,taker_13612,this$__$1))
);
} else
{}
{
...
var putter_13614 = self__.puts.pop();if(!((putter_13614 == null)))
{var put_handler_13615 = putter_13614.handler;var val_13616 = putter_13614.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_13615))
{var put_cb_13617 = cljs.core.async.impl.protocols.commit.call(null,put_handler_13615);var __13618__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_13617,__13618__$1,put_handler_13615,val_13616,putter_13614,_,retval,this$__$1){
return (function (){return put_cb_13617.call(null,true);
});})(put_cb_13617,__13618__$1,put_handler_13615,val_13616,putter_13614,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_13616);
} else
{{
continue;
}
