...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13603 = (0);while(true){
var m_13604 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13604 == null))
{} else
{m_13604.call(null);
if((count_13603 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13605 = (count_13603 + (1));
count_13603 = G__13605;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3532__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3532__auto__)
