...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__5167__auto__,writer__5168__auto__,opt__5169__auto__){
return cljs.core._write.call(null,writer__5168__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4569__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__4569__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__4569__auto__)){
return or__4569__auto__;
} else {
...
var G__11883 = o;
(G__11883[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__11885__i < G__11885__a.length) {G__11885__a[G__11885__i] = arguments[G__11885__i + 0]; ++G__11885__i;}
  args = new cljs.core.IndexedSeq(G__11885__a,0);
} 
...
var old_11887 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_11887))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_11887)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__4557__auto__ = (node === document.activeElement);
if(and__4557__auto__){
var and__4557__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__4557__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__11890 = jsprops;
(G__11890["defaultValue"] = value);

(G__11890["onChange"] = ((function (G__11890,v,value,on_change){
return (function (p1__11888_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__11888_SHARP_);
});})(G__11890,v,value,on_change))
);
...
var vec__11892 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__11892,(0),null);
var id = cljs.core.nth.call(null,vec__11892,(1),null);
var class$ = cljs.core.nth.call(null,vec__11892,(2),null);
...
var temp__4427__auto__ = (function (){var G__11896 = cljs.core.meta.call(null,v);
var G__11896__$1 = (((G__11896 == null))?null:reagent.impl.template.get_key.call(null,G__11896));
return G__11896__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__11898_11899 = v;
var G__11898_11900__$1 = (((G__11898_11899 == null))?null:reagent.impl.template.key_from_vec.call(null,G__11898_11899));
var G__11898_11901__$2 = (((G__11898_11900__$1 == null))?null:(jsprops["key"] = G__11898_11900__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__11904 = cljs.core.meta.call(null,argv);
var G__11904__$1 = (((G__11904 == null))?null:reagent.impl.template.get_key.call(null,G__11904));
return G__11904__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__11905 = (((jsprops == null))?{}:jsprops);
(G__11905["key"] = key);
...
var G__11906 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__11906;
continue;
}
} else {
...
var n__5472__auto___11907 = a.length;
var i_11908 = (0);
while(true){
if((i_11908 < n__5472__auto___11907)){
(a[i_11908] = reagent.impl.template.as_element.call(null,(a[i_11908])));
...
var a = cljs.core.into_array.call(null,s);
var n__5472__auto___11910 = a.length;
var i_11911 = (0);
while(true){
if((i_11911 < n__5472__auto___11910)){
var val_11912 = (a[i_11911]);
if((cljs.core.vector_QMARK_.call(null,val_11912)) && ((reagent.impl.template.key_from_vec.call(null,val_11912) == null))){
(o["no-key"] = true);
} else {
}

(a[i_11911] = reagent.impl.template.as_element.call(null,val_11912));
...
if(cljs.core.truth_((function (){var and__4557__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__4557__auto__){
return (ctx["no-key"]);
} else {
return and__4557__auto__;
...
var G__11915 = (cljs.core.count.call(null,argv) - first_child);
switch (G__11915) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__11915){
